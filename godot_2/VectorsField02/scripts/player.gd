...
func _draw():
#	self.draw_line( asteroid_position, asteroid_position + test_vector * 6000, line_color1)
...
func display_vectors():
	...
	get_node("Label_position").set_text( str(position.floor()) )
